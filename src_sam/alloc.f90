...
allocate(theta(nzm), thetav(nzm), thetar(nzm), thetali(nzm), pres(nzm), tabs(nzm), tabs0(nzm), &
                    ...
                    rho_i(2:nzm), w(nz), ug(nzm), vg(nzm),dqtdt(nzm), dtdt(nzm), presi(nz))
...
allocate(qcsgs_mf(nz), qcsgs_pdf(nzm), qisgs_mf(nz), qisgs_pdf(nzm), cfrac_mf(nz), cfrac_pdf(nzm), tke_thvflx(nzm))
...
allocate(UPM(nz,nup),UPW(nz,nup),UPT(nz,nup),UPQT(nz,nup),UPQCL(nz,nup),UPQCI(nz,nup),&
         ...
         BUOY(nzm,nup),DET(nzm,nup),UPTHD(nzm,nup),ENT(nzm,nup),BUOY(nzm,nup),DET(nzm,nup),&
         UPTHD(nzm,nup),UPCF(nzm,nup))
